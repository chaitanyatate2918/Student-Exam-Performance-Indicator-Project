...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            logging.info("Split data into train test sets")
            ...
            print(f"The best model is: {best_model}, accuracy score:  {best_model_score}")
            logging.info(f"The best model is: {best_model}, accuracy score:  {best_model_score}")
